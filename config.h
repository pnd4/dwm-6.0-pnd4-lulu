...
static Key keys[] = {
    ...
    { SEARCHKEY,                XK_F9,                      spawn,          {.v = voldown } },
    { SEARCHKEY,                XK_F10,                     spawn,          {.v = volup } },
    ...
    { SEARCHKEY,                XK_Left,                    focusmon,       {.i = -1 } },
    { SEARCHKEY,                XK_Right,                   focusmon,       {.i = +1 } },
    { SEARCHKEY|ShiftMask,      XK_Left,                    tagmon,         {.i = -1 } },
    { SEARCHKEY|ShiftMask,      XK_Right,                   tagmon,         {.i = +1 } },
};
